...
class InfiniteMode: CCNode {
    ...
    */
    ...
    func playEndGameAnimationSequence() {
        ...
        self.leftTimerOutline.runAction(CCActionFadeTo(duration: 0.5, opacity: 0))
        self.rightTimerOutline.runAction(CCActionFadeTo(duration: 0.5, opacity: 0))
        self.leftLifeBar.runAction(CCActionFadeTo(duration: 0.5, opacity: 0))
        self.rightLifeBar.runAction(CCActionFadeTo(duration: 0.5, opacity: 0))
